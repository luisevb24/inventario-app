  ...
  return (
    <main className="max-w-6xl mx-auto p-4">
      <div className="flex justify-between items-center mb-6">
        ...
        <h1 className="bg-dark text-2xl font-bold text-center">
          Presupuesto</h1>
        <h1 className="bg-dark text-2xl font-bold text-center">
          {projectId}</h1>
      ...
      {/* Project Info Card */}
      {projectData && (
        <div className="bg-white rounded-lg shadow overflow-hidden mb-8 table-content">
          <div className="p-4 bg-gray-50 border-b border-gray-200 table-header">
      ...
      {/* Labor Section */}
      <div className="my-6">
        <h2 className="bg-dark text-xl font-semibold mb-2">Mano de Obra</h2>
        <ManoObraTable
      ...
      {categorias.map(categoria => (
        <div key={categoria} className="my-6">
          <h2 className="bg-dark text-xl font-semibold mb-2">{categoria}</h2>
          <InventarioTable
